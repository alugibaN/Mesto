...
function editProfile(evt) {
  evt.preventDefault();
  loadingAdd({
    buttonElement: popupFormSabmitEditProfile,
    text: "Сохраняем...",
    disabled: true,
  });
  const profile = {
    name: inputNameFormProfile.value,
    about: inputHobbyFormProfile.value,
  };
...
function addPost(evt) {
  evt.preventDefault();
  loadingAdd({
    buttonElement: popupFormSabmitEditMesto,
    text: "Сохраняем...",
    disabled: true,
  });
...
function createAvatar(evt) {
  evt.preventDefault();
  loadingAdd({
    buttonElement: popupFormSabmitEditAvatar,
    text: "Сохраняем...",
    disabled: true,
  });
